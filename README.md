...
* [stac-utils](https://github.com/stac-utils) - Tools for working with SpatioTemporal Asset Catalogs (STAC) (perhaps worth going here first for STAC) `Python` `Javascript`
  ...
  * [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 324 | 🐛 40 | 🌐 Python | 📅 2026-09-09 - STAC API implementation with FastAPI. `Python`
  ...
  * [elastic search](https://github.com/stac-utils/stac-fastapi-elasticsearch-opensearch) ⭐ 79 | 🐛 34 | 🌐 Python | 📅 2026-09-18 - Elasticsearch backend for stac-fastapi with Opensearch support. `Python`
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,186 | 🐛 24 | 🌐 Python | 📅 2026-09-18 - A modern dynamic tile server built on top of `FastAPI` and `Rasterio/GDAL`.
...
* [SatPy](https://github.com/pytroll/satpy) ⭐ 1,206 | 🐛 573 | 🌐 Python | 📅 2026-09-18 - `Python` package for earth-observing satellite data processing
...
* [Worldview](https://github.com/nasa-gibs/worldview) ⭐ 1,866 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-18 - Interactive interface for browsing global, full-resolution satellite imagery `Javascript` application [here](https://worldview.earthdata.nasa.gov/)
...
* [GEE Map](https://github.com/giswqs/geemap) ⭐ 4,027 | 🐛 59 | 🌐 Python | 📅 2026-09-17 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets
* [Earth Engine API](https://github.com/google/earthengine-api) ⭐ 3,421 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-18 - `Python` and `JavaScript` bindings for calling the Earth Engine API.
...
* [datacube-explorer](https://github.com/opendatacube/datacube-explorer) ⭐ 64 | 🐛 53 | 🌐 JavaScript | 📅 2026-09-18 - Web-based exploration of Open Data Cube collections
...
* [grass-dev-py3-pdal](https://github.com/OSGeo/grass/tree/master/docker) ⭐ 1,165 | 🐛 695 | 🌐 C | 📅 2026-09-18 - Dockerfile which compiles GRASS GIS 7.9 master with Python 3 and PDAL suppor
...
* [usgs-lidar](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-18 - AWS Entwine Point Tiles USGS LiDAR Public Dataset GitHub repo
...
* [introduction to ml with Python](https://github.com/amueller/introduction_to_ml_with_python) ⭐ 8,188 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2024-03-14 - Notebooks and code for the book "Introduction to Machine Learning with `Python`"
