...
Not sure the best place for data catalogs is but this is a good start if that interests you [Data Catalogs](https://github.com/opengeos/geospatial-data-catalogs) ⭐ 662 | 🐛 0 | 🌐 Python | 📅 2026-09-09
...
* [CostalSat](https://github.com/kvos/CoastSat) ⭐ 890 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-06-05 - Global shoreline mapping tool from satellite imagery `Python`
...
* [pyresample](https://github.com/pytroll/pyresample) ⭐ 385 | 🐛 125 | 🌐 Python | 📅 2026-09-09 - Geospatial image resampling in `Python`
...
* [mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 50 | 🌐 Python | 📅 2026-09-07 - Tile-based geodata processing using rasterio & Fiona `Python`
...
* [stac-utils](https://github.com/stac-utils) - Tools for working with SpatioTemporal Asset Catalogs (STAC) (perhaps worth going here first for STAC) `Python` `Javascript`
  * [STAC Spec](https://github.com/radiantearth/stac-spec) ⭐ 926 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-26 - SpatioTemporal Asset Catalog specification - making geospatial assets openly searchable and crawlable
  ...
  * [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 72 | 🌐 PLpgSQL | 📅 2026-08-31 - Schema, functions and a `Python` library for storing and accessing STAC collections and items in `PostgreSQL`
  * [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 72 | 🌐 PLpgSQL | 📅 2026-08-31 - Schema, functions and a python library for storing and accessing STAC collections and items in PostgreSQL
  ...
  * [stac-rs](https://github.com/stac-utils/stac-rs) ⭐ 144 | 🐛 29 | 🌐 Rust | 📅 2026-09-08 - `Rust` implementation of the SpatioTemporal Asset Catalog (STAC) specification
  * [stac-rs](https://github.com/stac-utils/stac-rs) ⭐ 144 | 🐛 29 | 🌐 Rust | 📅 2026-09-08 - Tools and libraries for the SpatioTemporal Asset Catalog (STAC) specification, written in `Rust`
  * [titiler-pgstac](https://github.com/stac-utils/titiler-pgstac) ⭐ 131 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - TiTiler + PgSTAC
  * [stac-fastapi-pgstac](https://github.com/stac-utils/stac-fastapi-pgstac) ⭐ 112 | 🐛 35 | 🌐 Python | 📅 2026-09-09 - PostgreSQL backend for stac-fastapi using pgstac
  ...
  * [elastic search](https://github.com/stac-utils/stac-fastapi-elasticsearch-opensearch) ⭐ 79 | 🐛 33 | 🌐 Python | 📅 2026-09-09 - Elasticsearch backend for stac-fastapi with Opensearch support. `Python`
...
* [cogeotiff](https://github.com/blacha/cogeotiff) ⭐ 116 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-07 - High performance cloud optimised geotiff reader
...
* [Planet-client-API](https://github.com/planetlabs/planet-client-python) ⭐ 298 | 🐛 84 | 🌐 Python | 📅 2026-09-09 - `Python` client for Planet APIs
...
* [up42-py](https://github.com/up42/up42-py) ⭐ 144 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Python SDK for UP42, the geospatial marketplace and developer platform. `Python`
...
* [SatPy](https://github.com/pytroll/satpy) ⭐ 1,205 | 🐛 563 | 🌐 Python | 📅 2026-09-09 - `Python` package for earth-observing satellite data processing
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 79 | 🌐 Python | 📅 2026-09-09 - Raster-based Spatial Analysis for `Python`
...
* [actinia core](https://github.com/mundialis/actinia_core) ⭐ 96 | 🐛 33 | 🌐 Python | 📅 2026-09-09 - Actinia Core is an open source REST API for scalable, distributed, high performance processing of geographical data that uses mainly GRASS GIS for computational tasks. `Python`
...
* \[titiler-eopf]\(<https://github.com/EOPF-Explorer/titiler-eopf> ⭐ 18 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2026-09-09 - TiTiler application for EOPF dataset `Python`
...
* [Worldview](https://github.com/nasa-gibs/worldview) ⭐ 1,853 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-04 - Interactive interface for browsing global, full-resolution satellite imagery `Javascript` application [here](https://worldview.earthdata.nasa.gov/)
* [PDAL](https://github.com/PDAL/PDAL) ⭐ 1,409 | 🐛 135 | 🌐 C++ | 📅 2026-09-06 - PDAL is Point Data Abstraction Library. GDAL for point cloud data.
...
* [stac-browser](https://github.com/radiantearth/stac-browser) ⭐ 418 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-09 - A Vue-based STAC browser intended for static + dynamic deployment
...
* [Segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,138 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - A `Python` package for segmenting geospatial data with the Segment Anything Model (SAM). [docs](https://samgeo.gishub.org/)
...
* [Earth-Copilot](https://github.com/microsoft/Earth-Copilot/) ⭐ 194 | 🐛 9 | 🌐 Python | 📅 2026-09-06 - An AI powered geospatial application that allows you to explore and visualize Earth science data using natural language.
...
* [GEE Map](https://github.com/giswqs/geemap) ⭐ 4,023 | 🐛 53 | 🌐 Python | 📅 2026-09-09 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets
* [Earth Engine API](https://github.com/google/earthengine-api) ⭐ 3,417 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-08 - `Python` and `JavaScript` bindings for calling the Earth Engine API.
...
* [Digital Earth Australia Notebooks](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 536 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Repository for Jupyter Notebooks, tools and workflows for continental-scale earth observation/geospatial analysis with Open Data Cube and `xarray` `Python`
...
* [datacube-explorer](https://github.com/opendatacube/datacube-explorer) ⭐ 64 | 🐛 48 | 🌐 JavaScript | 📅 2026-09-08 - Web-based exploration of Open Data Cube collections
...
* [Opendatacube](https://github.com/opendatacube)
  * [Datacube Core](https://github.com/opendatacube/datacube-core) ⭐ 588 | 🐛 82 | 🌐 Python | 📅 2026-09-09 - Open Data Cube analyses continental scale Earth Observation data through time `Python` `xarray`
  * [Datacube OWS](https://github.com/opendatacube/datacube-ows) ⭐ 85 | 🐛 37 | 🌐 Python | 📅 2026-09-09 - Open web services for the Open Data Cube. Supports WMS, WMTS and WCS for any dataset indexed into the ODC `Python`
...
* [grass-dev-py3-pdal](https://github.com/OSGeo/grass/tree/master/docker) ⭐ 1,162 | 🐛 704 | 🌐 C | 📅 2026-09-08 - Dockerfile which compiles GRASS GIS 7.9 master with Python 3 and PDAL suppor
...
* [usgs-lidar](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - AWS Entwine Point Tiles USGS LiDAR Public Dataset GitHub repo
...
* [isce2](https://github.com/isce-framework/isce2) ⭐ 665 | 🐛 253 | 🌐 Python | 📅 2026-06-30 - InSAR Scientific Computing Environment version 2 `Python`
...
* [ISCE](https://github.com/isce-framework/isce3) ⭐ 237 | 🐛 160 | 🌐 Python | 📅 2026-09-08 - InSAR Scientific Computing Environment version 3 alpha
...
* [Deep learning with Python notebooks](https://github.com/fchollet/deep-learning-with-python-notebooks) ⭐ 20,287 | 🐛 218 | 🌐 Jupyter Notebook | 📅 2025-09-18 - Jupyter notebooks for the code samples of the book "Deep Learning with Python"
...
* [Xarray](https://github.com/pydata/xarray) ⭐ 4,195 | 🐛 1,440 | 🌐 Python | 📅 2026-09-09 - N-D labeled arrays and datasets in Python
